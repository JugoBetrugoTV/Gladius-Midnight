...
function layout:Initialize(frame)
    ...
    if self.db.hideNameBackground then
        frameTexture:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\UI-HUD-UnitFrame-Target-PortraitOn-NoShadow.tga")
    else
        frameTexture:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\UI-HUD-UnitFrame-Target-PortraitOn.tga")
    end
