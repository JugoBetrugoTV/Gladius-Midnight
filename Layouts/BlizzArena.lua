...
function layout:Initialize(frame)
    ...
    if self.db.trinketCircleBorder then
        GladiusMixin.showTrinketCircleBorder = true
        ...
        if not trinket.TrinketCircleBorderHook then
            hooksecurefunc(trinket.Texture, "SetTexture", function(self, t)
                if not t or not GladiusMixin.showTrinketCircleBorder then
    ...
    frame.AuraStacks:SetFont("Interface\\AddOns\\GladiusMidnight\\Textures\\arialn.ttf", 11, "THICKOUTLINE")
