...
layout.defaultSettings = {
    ...
    textures          = {
        ...
        healStatusBarTexture          = "Gladius Stripes 2",
        castbarStatusBarTexture       = "Gladius Default",
        castbarUninterruptibleTexture = "Gladius Default",
        bgTexture = "Solid",
        bgColor = {0, 0, 0, 0.6},
    },
...
function layout:Initialize(frame)
    ...
    if (frame:GetID() == GladiusMixin.maxArenaOpponents) then
    ...
    frame.ClassIcon.Mask:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    frame.ClassIcon.Mask:SetAllPoints(classIcon.Texture)
    classIcon.Texture:AddMaskTexture(frame.ClassIcon.Mask)
    frame.ClassIcon.Cooldown:SetSwipeTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout")
    ...
    trinket.Mask:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    trinket.Mask:SetAllPoints(trinket.Texture)
    trinket.Texture:AddMaskTexture(trinket.Mask)
    trinket.Cooldown:SetSwipeTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout")
    ...
    racial.Mask:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    ...
    racial.Cooldown:SetSwipeTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout")
    ...
    dispel.Mask:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout", "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE")
    dispel.Mask:SetAllPoints(dispel.Texture)

    -- Apply the mask
    dispel.Texture:AddMaskTexture(dispel.Mask)

    dispel.Cooldown:SetSwipeTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\talentsmasknodechoiceflyout")
    ...
    specBorder:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\Map_Faction_Ring.tga")
    ...
    frameTexture:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\UI-HUD-UnitFrame-Player-PortraitOff-Large.tga")
    frameTexture:SetDrawLayer("OVERLAY", 5)
    frameTexture:SetTexCoord(0, 1, 0, 1)
    frameTexture:Show()

    if not GladiusMixin.isRetail then
...
GladiusMixin.layouts[layoutName] = layout
GladiusMixin.defaultSettings.profile.layoutSettings[layoutName] = layout.defaultSettings
