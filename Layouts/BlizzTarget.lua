...
function layout:Initialize(frame)
    ...
    frame.AuraStacks:SetFont("Interface\\AddOns\\GladiusMidnight\\Textures\\arialn.ttf", 18, "THICKOUTLINE")
    ...
    if self.db.bigHealthbar then
        ...
        frameTexture:SetTexture("Interface\\AddOns\\GladiusMidnight\\Textures\\UI-TargetingFrame-NoLevel-Large")
    else
