--[[
    ...
    Tabs: General | Modules | DR Tracker | Indicators | Styling | Layout | Profiles
]]
...
GladiusMixin.optionsTable = {
    ...
    args = {
                ...
                displayGroup = {
                    ...
                    args = {
                        ...
                        stealthAlpha = {
                            order = 3,
                            name = "Stealth Alpha",
                            desc = "Transparency for stealthed opponents (0 = invisible, 1 = fully visible).",
                            type = "range",
                            min = 0, max = 1, step = 0.05,
                            width = 1.4,
                            get = function() return GladiusMixin.stealthAlpha or 0.4 end,
                            set = function(_, val)
                ...
                frameGroup = {
                    ...
                    args = {
                        ...
                        scale = {
                            ...
                            type = "range",
                            min = 0.1, max = 5.0, softMin = 0.5, softMax = 3.0,
                            step = 0.01, bigStep = 0.1, isPercent = true,
                            get = function()
                                local ls = getLS()
                ...
                castBarPosGroup = {
                    ...
                    args = {
                        posX = {
                            ...
                            name = "X Offset",
                            type = "range",
                            min = -700, max = 700, softMin = -350, softMax = 350,
                            step = 0.1, bigStep = 1,
                            get = function()
                                local ls = getLS()
        ...
        ---------------------------------------------------------------
        -- TAB 7: PROFILES (placeholder, populated after DB creation)
        ---------------------------------------------------------------
        profiles = {
            order = 7,
            name = "Profiles",
