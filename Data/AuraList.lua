-- Gladius Midnight - Aura Priority List
-- Aura priorities for arena enemy unit frames
-- Priority scale: 9+ = CC/Immunity, 8 = Immunity, 7 = Partial Immunity,
--   6 = Interrupt/Silence, 5 = Disarm, 4 = Root, 3 = Offensive Buff,
--   2.5 = Defensive Buff, 2 = Misc, 1 = Druid Forms

local _, Gladius = ...

-- Auras that need tooltip info to display stack counts
GladiusMixin.tooltipInfoAuras = {}

-- Spell lock duration reduction modifiers
GladiusMixin.spellLockReducer = {
    [317920] = 0.7, -- Concentration Aura
    [234084] = 0.5, -- Moon and Stars
    [383020] = 0.5, -- Tranquil Air
}

-- Main aura priority table: spellID = priority
GladiusMixin.auraList = {
    ...
    -----------------------------------------------------------------------
    -- Misc Buffs/Debuffs (2)
    -----------------------------------------------------------------------
    [212431] = 2,     -- Explosive Shot
    [382440] = 2,     -- Shifting Power
    [394087] = 2,     -- Mayhem
    [431177] = 2,     -- Frostfire Empowerment
