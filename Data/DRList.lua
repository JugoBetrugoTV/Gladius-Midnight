--[[
    Gladius Midnight - DR List (Retail / Midnight 12.0)
    Diminishing Returns spell data.
    Source: sArena_Reloaded/Data/DRs/DrList_Retail.lua
    All spell IDs and category mappings kept identical.
]]

GladiusMixin.drCategories = {
    "Incapacitate",
    "Stun",
    "Root",
    "Disarm",
...
-- No per-spec or per-class icon overrides in source data
-- GladiusMixin.drIconsPerSpec  = {}
-- GladiusMixin.drIconsPerClass = {}
...
GladiusMixin.drList = {
    ...
    -- Note: Roots with duration <= 2s have no DR and are commented out
